...
public class SysLoginService
{
    ...
    public SysUser login(String username, String password)
    {
        ...
        // 查询用户信息
        SysUser user = userService.selectUserByLoginName(username,UserConstants.USER_SYS);
        if (user == null){
            user = userService.selectUserByLoginName(username,UserConstants.USER_VIP);
        }
...
//        }
        ...
        // 查询用户信息
        SysUser user = userService.selectUserByLoginName(username, userType);

        if (user == null && maybeMobilePhoneNumber(username))
        {
            user = userService.selectUserByPhoneNumber(username, userType);
        }

        if (user == null && maybeEmail(username))
        {
            user = userService.selectUserByEmail(username, userType);
        }
